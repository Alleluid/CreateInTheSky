...
public class ItemMortarPestle extends Item {
    ...
    public ActionResultType onItemUse(@Nonnull ItemUseContext context) {
        ...
        if (recipeResult){
            ...
            world.playEvent(2001, pos, Block.getStateId(blockState)); // Play block break effects (I think)
            world.setBlockState(pos, fluidState.getBlockState(), 3); // flags | 1: block update, 2: send to clients. TODO: Block update not working..?
        }
